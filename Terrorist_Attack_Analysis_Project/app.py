...
from routs.Group_A import group_A_Blueprint, avg_casualties_per_region, yearly_change_per_region, \
...
def home():
    ...
    if query_type == "avg_casualties_per_region":
        ...
        rows = groups_with_same_targets_in_region(region=region)
        ...
        rows = regions_with_most_unique_groups(limit=20)  # מגבלה ל-20 תוצאות
        rows = rows[:20]
        ...
        rows = regions_with_high_group_diversity(region=region, country=country, limit=20)
